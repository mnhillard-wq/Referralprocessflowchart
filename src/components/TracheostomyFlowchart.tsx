...
import { FileText, Users, BookOpen, FileCheck, ClipboardCheck, Database, UserCheck, CheckSquare, Stethoscope, Printer, Wind } from 'lucide-react';
import { Card } from './ui/card';
import { Checkbox } from './ui/checkbox';
import { Button } from './ui/button';

export function TracheostomyFlowchart() {
  const handlePrint = () => {
    window.print();
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 to-purple-50 p-4">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-2">
          <h1 className="text-violet-900 mb-0.5">Tracheostomy Caregiver Education</h1>
          <p className="text-gray-600">Simulation Discharge Program (SDP)</p>
        </div>

        {/* Color Legend */}
        <div className="bg-white rounded-lg shadow-md border-2 border-violet-200 p-3 mb-3 print:mb-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
          ...
          <div className="flex flex-col items-center space-y-1">
            <div className="bg-violet-700 text-white px-2 py-1 rounded-lg shadow-lg mb-0.5">
              <h2>Process Flow</h2>
            </div>
              ...
              <div className="space-y-1.5">
                <div className="bg-blue-100 rounded-lg p-1.5 border border-blue-300">
                  <p className="text-blue-900 text-sm">
                    <span className="font-semibold">Smart Phrase:</span> <code className="bg-white px-1.5 py-0.5 rounded text-blue-700 text-xs">.SDPTRACH</code>
                  </p>
                </div>
                <div className="space-y-1.5">
                  <div className="flex justify-center">
                    <a 
                      href="https://drive.google.com/file/d/1QHygnbkTKfwm3vitnUL-pzGSCTPkAdrT/view?usp=drive_link" 
                      target="_blank" 
                      rel="noopener noreferrer"
                    ...
                    >
                      <BookOpen size={14} />
                      View Parent Care Booklet (English)
                    </a>
                  </div>
                  <div className="flex gap-2 justify-center">
                    <a 
                      href="https://drive.google.com/file/d/1LzghTbiqCNUxVqQvnCcv9JuWB4zwmHQ5/view?usp=drive_link" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 px-2 py-1 bg-amber-500 hover:bg-amber-600 text-white rounded transition-colors text-xs"
                    >
                      <BookOpen size={12} />
                      Spanish
                    </a>
                    <a 
                      href="https://drive.google.com/file/d/1g9hPFLMAXsgFnPXAnvELZkTrlOhJCuSU/view?usp=drive_link" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 px-2 py-1 bg-amber-500 hover:bg-amber-600 text-white rounded transition-colors text-xs"
                    >
            ...
            <div id="skills-checklist-step">
              <FlowchartNode
                ...
                icon={<ClipboardCheck className="text-violet-600" size={20} />}
                variant="violet"
                compact
              >
                <div className="flex justify-center">
                  <a 
                    href="https://docs.google.com/document/d/1mtbVpmZESywxMx7JfNGdBLLT6nJYAmgD/edit?usp=drive_link&ouid=104174892965250681794&rtpof=true&sd=true" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-2 py-1.5 bg-violet-600 hover:bg-violet-700 text-white rounded transition-colors text-xs"
                  >
                    <FileText size={14} />
            ...
            <FlowchartNode
              type="process"
              title="Family Readiness Confirmed"
              description="Parents feel comfortable with all skills and items on the family discharge checklist"
              icon={<CheckSquare className="text-violet-600" size={20} />}
              variant="violet"
              compact
            >
              <div className="flex justify-center">
                <a 
                  href="https://docs.google.com/document/d/1IIkSRn12MLxtfuQZhMK1Fw1ll7b5OtVh/edit?usp=drive_link&ouid=104174892965250681794&rtpof=true&sd=true" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-2 py-1.5 bg-violet-600 hover:bg-violet-700 text-white rounded transition-colors text-xs"
                >
            ...
            {/* Step 5: Discharge Documentation */}
            <FlowchartNode
              type="process"
            ...
            >
              <div className="bg-blue-100 rounded-lg p-1.5 border border-blue-300">
                <p className="text-blue-900 text-sm">
                  <span className="font-semibold">Smart Phrase:</span> <code className="bg-white px-1.5 py-0.5 rounded text-blue-700 text-xs">.TRACHNURSING</code>
                </p>
              </div>
            </FlowchartNode>
            ...
            {/* Step 6: Physician Review & Ready for Discharge */}
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-start gap-1.5 p-1.5 bg-purple-50 rounded">
                  ...
                  <label htmlFor="parents-comfortable" className="flex-1 cursor-pointer text-gray-900 text-sm">
                    Parents are comfortable with tracheostomy care
                  </label>
                </div>

                {/* Checklist Item 3 */}
                <div className="flex items-start gap-1.5 p-1.5 bg-purple-50 rounded">
                  <Checkbox id="ent-consult" className="mt-0.5" />
                  <label htmlFor="ent-consult" className="flex-1 cursor-pointer">
                    <div className="text-gray-900 text-sm">ENT consultation completed</div>
                    <div className="text-gray-600 text-xs">Can reach out to ENT via EPIC</div>
                  </label>
                </div>
                ...
                <div className="flex items-start gap-1.5 p-1.5 bg-purple-50 rounded">
                  ...
                  <label htmlFor="followup" className="flex-1 cursor-pointer">
                    ...
                    <div className="text-gray-600 text-xs space-y-0">
                      <div>• ENT follow-up within 2 weeks</div>
                      <div>• Home health nursing arranged</div>
                      <div>• Pulmonology follow-up within 4 weeks</div>
                    </div>
                  </label>
                </div>
                ...
                <div className="flex items-start gap-1.5 p-1.5 bg-purple-50 rounded">
                  ...
                  <label htmlFor="discharge-summary" className="flex-1 cursor-pointer">
                    <div className="text-gray-900 text-sm">Discharge summary documents trach care plan</div>
                    <div className="text-gray-600 text-xs">Includes trach size, type, and change schedule</div>
                  </label>
                </div>

                {/* Checklist Item 6 - Supplies */}
                <div className="flex items-start gap-1.5 p-1.5 bg-purple-50 rounded">
                  <Checkbox id="supplies" className="mt-0.5" />
                  <label htmlFor="supplies" className="flex-1 cursor-pointer">
                    <div className="text-gray-900 text-sm">All tracheostomy supplies ordered and delivered</div>
                    <div className="text-gray-600 text-xs grid grid-cols-2 gap-x-2 gap-y-0 mt-0.5">
                      <div>• Trach tubes (2 sizes)</div>
                      <div>• Suction catheters</div>
                      <div>• Suction machine</div>
                      <div>• Saline bullets</div>
                      <div>• Trach ties</div>
                      <div>• Gauze pads</div>
                      <div>• Ambu bag</div>
                      <div>• Oxygen (if needed)</div>
                      <div>• Humidifier</div>
                    </div>
                  </label>
                </div>

                {/* Checklist Item 7 - Emergency Plan */}
                <div className="flex items-start gap-1.5 p-1.5 bg-purple-50 rounded">
                  <Checkbox id="emergency-plan" className="mt-0.5" />
                  <label htmlFor="emergency-plan" className="flex-1 cursor-pointer">
                    <div className="text-gray-900 text-sm">Emergency action plan reviewed with family</div>
                    <div className="text-gray-600 text-xs">Includes decannulation and CPR protocols</div>
                  </label>
                </div>
              </div>
            </Card>
